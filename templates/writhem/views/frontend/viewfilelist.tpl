...
<table class="data Sortable highlight table table-striped">
	...
	<tr class="{cycle values=",alt"}">
		...
		{assign var="icon" value='templates/writhem/images/fileicons/'|cat:$file.ext|cat:".png"} 
		...
		<td width="30"><img title=".{$file.ext}" alt="{$file.ext}" src="{$smarty.const.WWW_TOP}/templates/writhem/images/fileicons/{$icon}.png" /></td>
